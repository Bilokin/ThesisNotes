...
\begin{wrapfigure}{R}{0.15\textwidth}
	...
	\caption{\sl A high deviation part of the global electroweak fit results from~\cite{bib:AfbSMFit}.}
	\label{fig:deviation}
\end{wrapfigure}
...
\begin{wrapfigure}{R}{0.2\textwidth}
	...
	\includegraphics[width=0.2\textwidth]{figures/vtx.png}
...
The kaon identification is possible using the TPC $dE/dx$ information. After equalizing the $dE/dx$ in angular spectrum, the kaons from b-hadron vertices can be identified with 97.\% purity and 87\% efficiency. However, the $B-\bar{B}$ oscillations will degrade the kaon charge signature purity for $B^0$ mesons.
\begin{center}\vspace{1cm}
...
\begin{itemize}
\item The developed procedure of the b-quark charge reconstruction allows to measure the b-quark polar angle. The residual impurity is corrected by a data-driven procedure;
\item The b-quark polar angle fit allows for independent determination of four electroweak couplings of the b-quark. The fit can be extended to the $\sin^2\theta$ term, which will involve the independent determination of the tensorial couplings;
