...
\begin{figure}
	\centering
	\includegraphics[width=0.95\textwidth]{ECAL/graphics/rpp_icru49_cu.eps}
...
The emission of photon or bremsstrahlung process is the dominant process of the electron-matter and positron-matter interaction, due to the the low electron mass value. 
...
The main characteristic of the material is the radiation length $X^0$, defined as the mean distance over which a high-energy electron loses all but $1/e$ of its energy, or $7/9$ of the mean free path of high-energy photon. 
...
The radiation length and Moli\`ere radius values for various materials are shown in Table~\ref{table:material}.
\input{ECAL/tables/material}
%High-energy photons lose energy by $e^+e^-$ pair creation 
