...
{\begin{center}
	...
	{ \normalsize Cascades hadroniques dans un calorim\`etre \'electromagn\'etique silicium-tungst\`ene hautement granulaire et production des quarks top et bottom \`a l'ILC}%\par
\end{center}

\vspace{0.3cm}

\hspace{1.5cm}{\textit{Th\`{e}se pr\'{e}sent\'{e}e et soutenue \`{a} Orsay, le 18 juillet 2017} \par}
\vspace{0.3cm}
...
\begin{tikzpicture}[remember picture, overlay]
    ...
    %%% title %%%
\justify{     {\bf Titre:} Cascades hadroniques dans un calorim\`etre \'electromagn\'etique silicium-tungst\`ene hautement granulaire et production des quarks top et bottom \`a l'ILC\\
	%%% key words %%%
    ...
    %%% title %%%
\justify{     {\bf Title:} Hadronic showers in a highly granular silicon-tungsten calorimeter and production of bottom and top quarks at the ILC\\
	%%% key words %%%
