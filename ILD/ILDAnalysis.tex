...
In this thesis the form factor formalism, defined in~\cite{bib:Schmidt}, is adopted.
...
The tree level \sm\ values of the form factors are weak and electric charges:
\begin{equation}
...
In case of polarized beams, the fermion form factors can be expressed in terms of the helicity of the initial electrons~\cite{bib:Schmidt}:
\begin{eqnarray}
...
\end{equation}
%where $\bar{B}$ is an average irreducible background estimate. 
...
The influence of irreducible background is considered as a systematic uncertainty. 
...
The measurements outside $Z^0$ pole were carried out within LEP~II programme, which collected the most integrated luminosity at around 190\,GeV energy, at the $W^\pm$-pair production threshold. 
The measured $A_{FB}^b$ at this center-of-mass energy agrees at 2\,$\sigma$ level with the \sm\ prediction.
...
Therefore, the hadron machines can measure the top quark mass as a cross section parameter with a high precision. 
...
Majority of the generated prongs have large offsets and an average momentum of $\sim$9\gev, which is above the ILD impact parameter resolution of 5\,$\mu$m. 
...
\begin{equation}
\epsilon/\sigma > 2 + 25\cdot\sqrt{\alpha}\text{ and } \alpha < 0.08.
\end{equation}
...
\end{equation}
where $\vec{p}_{b}$ and $\vec{p}_{\bar{b}}$ are the momentum vectors of the reconstructed b-quark jet and anti b-quark jet, respectively.
...
\end{equation} 
The difference in the generated b-quark polar angle distributions for two polarization configurations are caused by the difference between the $Z^0$ boson couplings to the left-handed and the right-handed fermions. 
