...
\begin{itemize}
	\item The value $g_R^Z$ has much larger uncertainty of $\pm$9.6\% as compared to the $\pm1$\% uncertainty on the $g_L^Z$ coupling;
...
\end{itemize}
The central values of the couplings obtained at LEP are
\begin{eqnarray}
...
\begin{figure}
	\centering
	\begin{subfigure}{0.5\textwidth}
		\includegraphics[width=0.95\textwidth]{ILD/plots/lep-result-zoom.pdf}
	...
	\end{subfigure}
	\caption{\sl Tree level 1\,$\sigma$ allowed regions defined by the forward-backward asymmetry and total cross section measurements at LEP (a) and ILC (b). Dashed guidelines show the \sm\ value.}
