...
In this studies, the top polar angle is calculated from the decay products of the of the hadronic top decay.
...
The charge of the reconstructed top quark in this studies can be defined using three basic signatures: jet charge measurement using secondary vertices or vertex charge, reconstructed kaon charge, and $W^\pm$ lepton charge. 
...
For single vertex and kaon charge methods the $A_{FB}^{rec}/A^{gen}_{FB} \approx 63\%$, while for the $W^\pm$ lepton charge method is 74\%. 

To avoid the charge migrations, one can use only the compatible combinations of two or more charge signatures.
In semileptonic \ttbar\ event one has two b-jets with vertex and kaon charge signatures each and a $W^\pm$ lepton charge signature. The general rules are:
\begin{itemize}
	\item The b-jets should have opposite both vertex and kaon charges;
