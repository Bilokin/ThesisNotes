...
The cross section measurement requires the high purity and the high efficiency signal selection against the background processes to minimize the statistical error and supress the background systematic effects~\cite{bib:steinberger}. 
