...
\end{figure}
The results can be improved by the application of the vertex charge recovery. 
...
\begin{itemize}
	...
	\item The \textit{main improvement} of the vertex charge recovery is the almost constant charge purity in the barrel. region, as can be seen in Fig.~\ref{fig:BAsymmetryRec_3}. This is the consequance of the recovering of the peaks of missing vertex particles as it is described in Sec.~\ref{sec:VtxRecovery}.
\end{itemize}
