...
The electron-positron colliders have a large production cross section of $e^+e^- \to q\bar{q}$ process mediated by $Z^0$ boson or a virtual photon. The total cross sections of various \sm\ processes for $e^+e^-$ machines are shown in Fig.~\ref{fig:ILCeplus}.
...
{\centering
    ...
    \caption{\sl The multiplicity of b-hadrons with $K^\pm$ among the generated prongs (green) and multiplicity of b-hadrons with $K^\pm$ of opposite charge to b-hadron charge.
    }
...
\begin{figure}[h]
{\centering
    \includegraphics[width=0.55\textwidth]{ILD/plots/dedx-results.pdf}
...
The dominant decay mode of the top quark is $t\to bW$, which is 99.8\% of all top decays. 
