...
To summarize, the VertexChargeRecovery is able to significantly improve the b-quark charge purity and equalize it in the polar angle spectrum, which is crucial for reconstruction of heavy quark differential cross section. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
The main goal of the study is to develop an alternative method to paper~\cite{bib:ILCTOP} by involving new b-quark charge measurement techniques, which should bring down the statistical uncertainties on the \ttbar Z$^0$ form factors and couplings.  
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Standalone b-quark charge application}
...
In case of the left-handed electron beam, the b-quarks are emitted into the direction of the initial top quark, which makes possible the standalone application the b-quark charge measurement. 
...
The combined b-quark charge measurement shows a good precision on the asymmetry $A_{FB}^{rec}/A^{gen}_{FB} \approx 93\%$ with total efficiency of 16\%.
\begin{figure}
	{\centering
...
\subsection{Outlook}
As it was shown, the involvement of the b-quark charge measurement to semileptonic \ttbar pair decays significantly increases the statistics used for the top polar angle computation.
...
The b-quark charge measurement is a completely independent reconstruction tool, which allows to study the top decay kinematics and to control the systematics effects.
...
The cross section measurement requires the high purity and the high efficiency signal selection against the background processes to minimize the statistical error and suppress the background systematic effects using double tagging method~\cite{bib:steinberger}. 
...
In general, the correlation factor value proportional to the $A_{FB}$ as \[\rho_{AB} = \frac{8}{3}\frac{\sigma_A}{\sigma_B}A_{FB},\]
where $\sigma_A$ and $\sigma_B$ are absolute errors on $A$ and $B$ parameters, respectively.
...
The extracted fit parameters $A^I$ and $B^I$ and the corresponding covariance matrix for two beam polarizations allow for extracting the $Z^0b\bar{b}$ couplings with the corresponding uncertainties. 
