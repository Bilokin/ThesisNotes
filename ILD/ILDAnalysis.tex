...
The corrected b-quark polar angle distributions with the overlaid background processes after vertex recovery are shown in Fig.
\begin{figure}
	\centering
	\begin{subfigure}{0.5\textwidth}
...
The final uncertainties on the measured total cross section and the forward-backward asymmetry values are displayed in Table~\ref{table:bbbarfinal}. These unceratinties are used to calculate the uncertainties on the b-quark electroweak couplings and the b-quark electroweak form factor values.
