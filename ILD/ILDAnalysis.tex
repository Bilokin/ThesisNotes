...
The $\pm$1\,$\sigma$ regions for the LEP measurements at $Z^0$ pole are shown in Fig.~\ref{fig:LEPILCResult_a_3}. This numerical result is obtained by variating the left-handed $Z^0b\bar{b}$ coupling $g^Z_L$ and the right-handed coupling $g^Z_R$ defined in \ref{formula:EWcouplings_3}, assuming uncorrelated measurements at LEP of $A_{FB}$ and $R_b$. 
\begin{figure}
	{\centering
...
\begin{itemize}
	\item The value $g_R^Z$ has much larger uncertainty of $\pm$9\% as compared to the $\pm1$\% uncertainty on the $g_L^Z$ coupling;
	\item The $g_R^Z$ is shifted w.r.t. the \sm\ value at $(0,0)$ by approximately $2.5\,\sigma$;
	\item The LEP~I measurements at $Z^0$ pole had no interference between $Z^0$ and $\gamma$ propagators, which leads to the sign ambiguity of the $g_R^Z$ coupling. This fact is reflected in Fig.~\ref{fig:LEPResultFull_3} as a second allowed region around $\delta g_R^Z / g_R^Z \approx -2.2$. 
\end{itemize}
