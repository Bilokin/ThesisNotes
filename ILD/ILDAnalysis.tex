...
All three basic methods, which are demonstrated in Fig.~\ref{fig:OneCharge_3}, have significant impurity, which cause the divergence between the generated polar angle distribution and all reconstructed curves. 
...
To avoid the charge migrations, one can use only the compatible combinations of these charges 
