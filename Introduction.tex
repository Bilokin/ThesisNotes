...
%The second part of the thesis concentrates on the analysis of the beam test data recorded with the CALICE Silicon-Tungsten Electromagnetic Calorimeter (\ecal) physics prototype. The granularity of this device allows disentangling fine details of the hadronic interaction events. Part~\ref{PARTII} of the thesis concentrates on the reconstruction of the secondary tracks from the $\pi^-$ interaction and data-simulation comparison using new variables from the developed track-finding algorithm.

%Part~\ref{PARTIII} unites several studies aimed at analysis of the $e^+e^- \to t\bar{t}  $ and $e^+e^- \to b\bar{b}$ channels at the ILC using full simulation of the ILD experiment. This chapter describes the developed methods of the b-jet charge measurement and their application to the \ttbar\ and \bbbar\ pair production processes at the ILC. 
